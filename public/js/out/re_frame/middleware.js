...
while (G__25274__i < G__25274__a.length) {G__25274__a[G__25274__i] = arguments[G__25274__i + 0]; ++G__25274__i;}
  args = new cljs.core.IndexedSeq(G__25274__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__25275){
...
return cljs.core.get_in.call(null,new_db,p1__25276_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__25277_SHARP_){
return cljs.core.get_in.call(null,db,p1__25277_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__25278__i < G__25278__a.length) {G__25278__a[G__25278__i] = arguments[G__25278__i + 2]; ++G__25278__i;}
  in_paths = new cljs.core.IndexedSeq(G__25278__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__25279){
var f = cljs.core.first(arglist__25279);
arglist__25279 = cljs.core.next(arglist__25279);
var out_path = cljs.core.first(arglist__25279);
var in_paths = cljs.core.rest(arglist__25279);
