...
var args25212 = [];
var len__22749__auto___25216 = arguments.length;
var i__22750__auto___25217 = (0);
while(true){
if((i__22750__auto___25217 < len__22749__auto___25216)){
args25212.push((arguments[i__22750__auto___25217]));

var G__25218 = (i__22750__auto___25217 + (1));
i__22750__auto___25217 = G__25218;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args25212.length)].join('')));
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4657__auto___25220 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__25211_SHARP_){
if(!((p1__25211_SHARP_ == null))){
if((false) || (p1__25211_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4657__auto___25220){
var not_reactive_25221 = temp__4657__auto___25220;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_25221);
} else {
}
} else {
}
