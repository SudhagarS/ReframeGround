...
if((i < len)){
var k = (ks[i]);
var G__24874 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__24875 = (i + (1));
m = G__24874;
i = G__24875;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__24879 = c;
var G__24879__$1 = (((G__24879 == null))?null:G__24879.prototype);
if((G__24879__$1 == null)){
return null;
} else {
return (G__24879__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__24883 = c;
var G__24883__$1 = (((G__24883 == null))?null:G__24883.prototype);
if((G__24883__$1 == null)){
return null;
} else {
return (G__24883__$1["render"]);
}
})()));
});
...
return (function() { 
var G__24887__delegate = function (args){
...
while (G__24888__i < G__24888__a.length) {G__24888__a[G__24888__i] = arguments[G__24888__i + 0]; ++G__24888__i;}
  args = new cljs.core.IndexedSeq(G__24888__a,0);
} 
return G__24887__delegate.call(this,args);};
G__24887.cljs$lang$maxFixedArity = 0;
G__24887.cljs$lang$applyTo = (function (arglist__24889){
var args = cljs.core.seq(arglist__24889);
return G__24887__delegate(args);
});
...
var _STAR_current_component_STAR_24892 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_24892;
}});
...
var G__24896 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__24896) {
...
var or__21674__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__24898_24900 = (c["cljsRatom"]);
if((G__24898_24900 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__24898_24900);
}
...
if(cljs.core.truth_((function (){var and__21662__auto__ = wrap;
...
if(((1) === cljs.core.count.call(null,renders_24903))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_24904)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_24904))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__21674__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__21674__auto__)){
return or__21674__auto__;
} else {
...
var render_fun__$1 = (function (){var or__21674__auto__ = render_fun;
if(cljs.core.truth_(or__21674__auto__)){
return or__21674__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__21674__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__21674__auto__)){
return or__21674__auto__;
} else {
...
var name__$1 = (function (){var G__24902 = name;
switch (G__24902) {
case "":
...
var G__24907 = o;
(G__24907[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__24913 = (function (){var or__21674__auto__ = (function (){var G__24915 = c;
if((G__24915 == null)){
return null;
} else {
return (G__24915["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__21674__auto__)){
return or__21674__auto__;
...
return (G__24913["_currentElement"]);
}
})();
var name = (function (){var G__24916 = elem;
var G__24916__$1 = (((G__24916 == null))?null:(G__24916["type"]));
if((G__24916__$1 == null)){
return null;
} else {
return (G__24916__$1["displayName"]);
}
})();
var path = (function (){var G__24917 = elem;
var G__24917__$1 = (((G__24917 == null))?null:(G__24917["_owner"]));
var G__24917__$2 = (((G__24917__$1 == null))?null:reagent$impl$component$component_path.call(null,G__24917__$1));
if((G__24917__$2 == null)){
return null;
} else {
return [cljs.core.str(G__24917__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__21674__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__21674__auto__)){
return or__21674__auto__;
} else {
var G__24919 = c;
var G__24919__$1 = (((G__24919 == null))?null:G__24919.constructor);
if((G__24919__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__24919__$1);
}
}
})();
