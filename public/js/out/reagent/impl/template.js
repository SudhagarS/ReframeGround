...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22280__auto__,writer__22281__auto__,opt__22282__auto__){
return cljs.core._write.call(null,writer__22281__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__24941 = o;
(G__24941[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__21662__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__21662__auto__){
var and__21662__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__21662__auto____$1){
var and__21662__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__24949 = jsprops;
(G__24949["defaultValue"] = value);

(G__24949["onChange"] = ((function (G__24949,v,value,on_change){
return (function (p1__24947_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24947_SHARP_);
});})(G__24949,v,value,on_change))
);
...
var vec__24956 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24956,(0),null);
var id = cljs.core.nth.call(null,vec__24956,(1),null);
var class$ = cljs.core.nth.call(null,vec__24956,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___24961 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___24961 == null)){
} else {
var key_24962 = temp__4661__auto___24961;
(jsprops["key"] = key_24962);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__24964 = (new reagent.impl.template.NativeWrapper());
(G__24964["name"] = c);
...
var len__22749__auto___24970 = arguments.length;
var i__22750__auto___24971 = (0);
while(true){
if((i__22750__auto___24971 < len__22749__auto___24970)){
args__22756__auto__.push((arguments[i__22750__auto___24971]));

var G__24972 = (i__22750__auto___24971 + (1));
i__22750__auto___24971 = G__24972;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__22757__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24968){
var G__24969 = cljs.core.first.call(null,seq24968);
var seq24968__$1 = cljs.core.next.call(null,seq24968);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__24969,seq24968__$1);
});
...
break;
default:
var G__24976 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24976;
continue;
...
var n__22589__auto___24979 = a.length;
var i_24980 = (0);
while(true){
if((i_24980 < n__22589__auto___24979)){
(a[i_24980] = reagent.impl.template.as_element.call(null,(a[i_24980])));

var G__24981 = (i_24980 + (1));
i_24980 = G__24981;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__22589__auto___24982 = a.length;
var i_24983 = (0);
while(true){
if((i_24983 < n__22589__auto___24982)){
var val_24984 = (a[i_24983]);
if((cljs.core.vector_QMARK_.call(null,val_24984)) && ((reagent.impl.template.key_from_vec.call(null,val_24984) == null))){
(o["no-key"] = true);
} else {
}

(a[i_24983] = reagent.impl.template.as_element.call(null,val_24984));

var G__24985 = (i_24983 + (1));
i_24983 = G__24985;
continue;
} else {
}
...
var ctx = {};
var vec__24989 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24989,(0),null);
var derefed = cljs.core.nth.call(null,vec__24989,(1),null);
...
var G__24993 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24993) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24993){
