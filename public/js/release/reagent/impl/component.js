...
if((i < len)){
var k = (ks[i]);
var G__12517 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12518 = (i + (1));
m = G__12517;
i = G__12518;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12522 = c;
var G__12522__$1 = (((G__12522 == null))?null:G__12522.prototype);
if((G__12522__$1 == null)){
return null;
} else {
return (G__12522__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12526 = c;
var G__12526__$1 = (((G__12526 == null))?null:G__12526.prototype);
if((G__12526__$1 == null)){
return null;
} else {
return (G__12526__$1["render"]);
}
})()));
});
...
var G__12530 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12530) : reagent.impl.component.as_element.call(null,G__12530));
};
var G__12532 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__12533__i = 0, G__12533__a = new Array(arguments.length -  0);
while (G__12533__i < G__12533__a.length) {G__12533__a[G__12533__i] = arguments[G__12533__i + 0]; ++G__12533__i;}
  args = new cljs.core.IndexedSeq(G__12533__a,0);
} 
return G__12532__delegate.call(this,args);};
G__12532.cljs$lang$maxFixedArity = 0;
G__12532.cljs$lang$applyTo = (function (arglist__12534){
...
var _STAR_current_component_STAR_12537 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12537;
}});
...
var G__12545 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12545) {
...
return ((function (G__12545){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12548 = reagent.impl.component.state_atom(c);
var G__12549 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12548,G__12549) : cljs.core.reset_BANG_.call(null,G__12548,G__12549));
});
;})(G__12545))
...
var or__6224__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__12551_12553 = (c["cljsRatom"]);
if((G__12551_12553 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12551_12553);
}
...
if(cljs.core.truth_((function (){var and__6212__auto__ = wrap;
if(cljs.core.truth_(and__6212__auto__)){
return f;
} else {
...
var renders_12556 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12557 = cljs.core.first(cljs.core.vals(renders_12556));
if((cljs.core.count(renders_12556) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12556))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12557)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12557], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6224__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6224__auto__)){
return or__6224__auto__;
} else {
...
var render_fun__$1 = (function (){var or__6224__auto__ = render_fun;
if(cljs.core.truth_(or__6224__auto__)){
return or__6224__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6224__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6224__auto__)){
return or__6224__auto__;
} else {
...
var name__$1 = (function (){var G__12555 = name;
switch (G__12555) {
case "":
...
var elem = (function (){var G__12566 = (function (){var or__6224__auto__ = (function (){var G__12568 = c;
if((G__12568 == null)){
return null;
} else {
return (G__12568["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6224__auto__)){
return or__6224__auto__;
...
return (G__12566["_currentElement"]);
}
})();
var name = (function (){var G__12569 = elem;
var G__12569__$1 = (((G__12569 == null))?null:(G__12569["type"]));
if((G__12569__$1 == null)){
return null;
} else {
return (G__12569__$1["displayName"]);
}
})();
var path = (function (){var G__12570 = elem;
var G__12570__$1 = (((G__12570 == null))?null:(G__12570["_owner"]));
var G__12570__$2 = (((G__12570__$1 == null))?null:reagent$impl$component$component_path(G__12570__$1));
if((G__12570__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12570__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6224__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6224__auto__)){
return or__6224__auto__;
} else {
var G__12572 = c;
var G__12572__$1 = (((G__12572 == null))?null:G__12572.constructor);
if((G__12572__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12572__$1);
}
}
})();
